...
<script>
	require([ "dojo/parser", "dijit/registry", "batts", "dijit/layout/SplitContainer", "dijit/TitlePane",
			"dijit/layout/ContentPane", "dijit/form/DropDownButton", "dijit/form/Button", 
			"dijit/layout/LayoutContainer", "dijit/layout/ContentPane", 
			"dijit/TooltipDialog", "dijit/form/TextBox", "dijit/form/Button", 
			"dijit/form/Form",
			"dojo/domReady!" ], 
...
<body class="claro">
	...
	<div id="appLayout" data-dojo-type="dijit.layout.SplitContainer">
		...
		<div id="actionsPane" data-dojo-type="dijit.layout.ContentPane" style="width: 110px; padding: 5px;">
			<div id="btnBoughtMore" data-dojo-type="dijit.form.DropDownButton" 
				disabled="true">
				<span>Got More</span>
				<div data-dojo-type="dijit.TooltipDialog" id="boughtDlg">
				<div data-dojo-type="dijit.form.Form" id="addMoreForm" action="" method="">
				  <div>
			     <label for="count">How many:</label> <input data-dojo-type="dijit.form.TextBox" id="count" name="count">
			     </div>
